...
if (isset($_POST['newproduct'])) {
    ...
    $addproduct = $product->addProduct($categoryid, $pname, $url, $dbconn->conn);

    if (isset($addproduct)) {
        $pid = $addproduct;
        $addproductDesc = $product->addProductDesc($pid, $prod_desc_json, $mprice, $aprice, $sku, $dbconn->conn);
        if (isset($addproductDesc)) {
