                ...
                <div class="table-responsive">
                    <table class="table align-items-center table-flush ctable">
                        ...
                        <tbody class="list">
                            ...
                            <div class="modal fade" id="deleteConfirm<?php echo $row['id']; ?>" tabindex="-1"
                            ...
                            <div class="modal fade" id="editform<?php echo $row['id']; ?>" tabindex="-1" role="dialog"
                                                    ...
                                                    <form role="form" action="adminMediater.php" method="POST">
                                                        ...
                                                        <div class="text-center">
                                                            <input type="submit" class="btn btn-primary mt-3"
                                                                value="Update Category" name="updateCategory">
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
