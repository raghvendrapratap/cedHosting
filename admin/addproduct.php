                                                ...
                                                <div class="pl-lg-4">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <label class="form-control-label">Web Space(in
                                                                    GB)</label>
                                                                <input type="text" class="form-control"
                                                                    placeholder="Web Space(in GB)" name="webspace">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <label class="form-control-label">Bandwidth (in
                                                                    GB)</label>
                                                                <input type="text" class="form-control"
                                                                    placeholder="Bandwidth (in GB)" name="bandwidth">
                                                                <h6 class="heading-small text-muted mb-4">Enter 0.5 for
                                                                    512 MB</h6>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <label class="form-control-label">Language /
                                                                    ...
                                                                    Support</label>
                                                                <input type="text" class="form-control"
                                                                    placeholder="Language/Technology" name="lang">
                                                    ...
                                                    <div class="text-center mt-5">
                                                        <input type="submit" value="Create New Product"
                                                            class="btn btn-primary" name="newproduct">
                                                    </div>
                                                </div>
                                            </form>
